% Experiment on synthetic hand pose depth images with 40% gross error
clear; clc;
gross_rate = 0.4;
...
clear Error; 
save Syn_hand4kd_Results2.mat W_OMR OMR_Output OMR_opts gross_rate;
...
clear Error W; 
save Syn_hand4kd_Results2.mat -append W_CMR CMR_Output CMR_opts;
...
clear Error;
save Syn_hand4kd_Results2.mat -append W_OMRG G_OMRG OMR_Gross_Output OMR_Gross_opts;
...
save Syn_hand4kd_Results2.mat -append W_CMRG G_CMRG CMR_Gross_Output CMR_Gross_opts;
exit
