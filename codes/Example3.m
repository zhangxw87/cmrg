function Example3(randVar)
% Example 3
% investigate the effect of sigmaMax

%% generate data
d = 1000; nTrain = 400; nValid = 400; nTest = 10^4; p = 13;
sigmaMaxSet = [sqrt(2) 2 4];
...
for k = 1:length(sigmaMaxSet)
    sigmaMax = sigmaMaxSet(k);
    ...
    %% print results
    fid = fopen(['../Results/Example3_Results_' num2str(randVar) '.txt'],'w+');
    fprintf(fid, ['%8.6f  '...
