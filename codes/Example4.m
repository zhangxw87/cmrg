function Example4(randVar)
% Example 4
% investigate the effect of gross_rate
...
for k = 1:length(rateSet)
    opts.gross_rate = rateSet(k);
    ...
    %% print results
    fid = fopen(['../Results/Example4_Results_' num2str(randVar) '.txt'],'a+');
    fprintf(fid, ['%8.6f  '...
